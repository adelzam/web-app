...
<header id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner" style="z-index: 1;position: relative;">
        <div class="item active">
            ...
            <div class="carousel-caption" style="margin-bottom: 170px;">
    ...
    <div style="width: 1237px; height: 128px; margin-left: 57px;margin-top: -200px; position: relative; background-color: rgba(66,66,66,0.8); align-items: center; z-index: 5;">
        <form method="post" name="searchForm" action="/search/results">
            <div>
                <input name="dep" tabindex="1" placeholder="Moscow"
            ...
            <div style="height: 48px; width: 43px; font-size: 30px; color: white; float: left ;margin-top: 40px;margin-left: 10px ">→</div>
            <div>
                <input tabindex="2" name="arr" placeholder="Kazan"
                       style="width: 307px; height: 48px; font-size: 25px; float: left; margin-top: 40px; margin-left: 0px"
                       value="" list="arr_list"/>
            ...
            <div>
                <input type="date" name="date" value="2016-06-09" min="2016-06-09"
            ...
            <div>
                <input type="submit" class="btn btn-primary" value="НАЙТИ" style="width: 88px; height: 48px; float: left; margin-top: 40px; margin-left: 5px
                " min="0" max="6">
            </div>
        </form>
    </div>
