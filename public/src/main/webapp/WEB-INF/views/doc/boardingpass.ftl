...
<div style="position:absolute;left:266px;top:469px" class="cls_006"><span class="cls_006">${ticket.num} </span></div>
<div style="position:absolute;left:718px;top:472px" class="cls_011"><span class="cls_011">${ticket.num} </span></div>
</div>
</body>
</html>
